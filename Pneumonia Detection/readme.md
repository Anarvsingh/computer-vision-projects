...
### About the Developer
Anarv is a Software Engineer with over 5 years of experience focused on backend development, distributed systems, and cloud-based applications. With a strong foundation in Python and Java, he specializes in building scalable services and optimizing application performance. This project serves as a comprehensive implementation of computer vision and deep learning techniques applied to medical diagnostic imaging.